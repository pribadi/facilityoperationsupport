...
spl_autoload_register(function ($className) {
    ...
    $path = "plugin_helpers/includes/{$className}.php";
...
function checkAttempts($username)
{
    ...
    try {
        //$fileLog = '/Users/aditiasap/Works/RAM/DashboardProject/dapot_ttc/application/logs/trace.log';
        ...
        //file_put_contents($fileLog, $stmt."\n", FILE_APPEND | LOCK_EX);
