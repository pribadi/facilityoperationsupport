    ...
    <section>
        <div class="rad-body-wrapper rad-nav-min">
            <div class="container-fluid">
                ...
                <?php endif; ?>
                <div class="col-xs-12">
                    <a href="<?php echo site_url('user/create');?>" class="btn btn-primary">Create User</a>
                    <br>
                    <br>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data as $v): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('user/update/'.$v['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                                            <a href="<?php echo site_url('user/delete/'.$v['id']); ?>" onClick="return doconfirm();"><i class="fa fa-remove" aria-hidden="true" style="color: #d9534f;"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
