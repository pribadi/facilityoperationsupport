                            ...
                            <?php echo form_open('user/create'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="level">
                                        ...
                                        <option value="Koordinator User" <?php echo set_select('level', 'Koordinator User'); ?>>Koordinator User</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="department">
                                        <option value="">...</option>
                                        <?php foreach ($dc as $value) : ?>
                                            <option value="<?php echo $value['DCName']; ?>"><?php echo $value['DCName']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
